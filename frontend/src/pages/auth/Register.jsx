...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gray-50 dark:bg-gray-900">
            ...
            {/* Floating Elements */}
            <div className="absolute top-20 right-20 w-72 h-72 bg-primary-500/30 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }} />
            <div className="absolute bottom-20 left-20 w-96 h-96 bg-ocean-500/30 rounded-full blur-3xl animate-float" style={{ animationDelay: '3s' }} />
